<div class="shadow overflow-hidden sm:rounded-md">
    <div class="px-4 py-5 bg-white sm:p-6">
        ...
        <div class="grid grid-cols-12 gap-2">
            ...
            {{-- <!-- Número identificacao -->
            <div class="col-span-12 sm:col-span-3 ">
                <div class="mt-4">

                    <x-label for="num_identificacao" :value="__('Número Identificação')" class="inline-flex " /> <span
                        class=" ml-1 text-sm text-red-700 inline-flex">*</span>

                    <x-input wire:model="animal.num_identificacao" id="num_identificacao" class="block mt-1 w-full" type="text" name="num_identificacao"
                        :value="old('num_identificacao')" />
                    @error('animal.num_identificacao') <span class="text-red-700">{{ $message }}</span> @enderror
                </div>
            </div> --}}
            <!-- Número Chip -->
            <div class="col-span-12 sm:col-span-3 ">
            ...
            <fieldset class="col-span-12 sm:col-span-3">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-center">
                        <input wire:model="animal.vacinado_polivalente" id="animal.vacinado_polivalenteS"
                            name="animal.vacinado_polivalente" type="radio"
                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" value="1">
                        <label for="push_everything" class="ml-3 block text-sm font-medium text-gray-700">
                            Sim
                        </label>
                    ...
                    <div class="flex items-center">
                        <input wire:model="animal.vacinado_polivalente" id="animal.vacinado_polivalenteN"
                            name="animal.vacinado_polivalente" type="radio"
                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" value="0">
                        <label for="push_email" class="ml-3 block text-sm font-medium text-gray-700">
                            Não
            ...
            <fieldset class="col-span-12 sm:col-span-3">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-center">
                        <input wire:model="animal.animal_rua" id="animal.animal_ruaS" name="animal.animal_rua"
                    ...
                    <div class="flex items-center">
                        <input wire:model="animal.animal_rua" id="animal.animal_ruaN" name="animal.animal_rua"
                            type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                            value="0">
                        <label for="push_email" class="ml-3 block text-sm font-medium text-gray-700">
                            Não
            ...
            <fieldset class="col-span-12 sm:col-span-3">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-center">
                        <input wire:model="animal.animal_ong" id="animal.animal_ongS" name="animal.animal_ong"
                            type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                            value="1">
                        <label for="push_everything" class="ml-3 block text-sm font-medium text-gray-700">
                            Sim
                    ...
                    <div class="flex items-center">
                        <input wire:model="animal.animal_ong" id="animal.animal_ongN" name="animal.animal_ong"
                            type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                            value="0">
                        <label for="push_email" class="ml-3 block text-sm font-medium text-gray-700">
                            Não
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-6">
                ...
                <div class="mt-4">
                    ...
                    <textarea wire:model="animal.observacao" id="animal.observacao" name="animal.observacao" rows="3"
