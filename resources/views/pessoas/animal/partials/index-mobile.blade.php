<div class="block md:hidden flex-col space-y-4 justify-center items-center">
  @if($modalOpen)
  ...
  <div class="w-full justify-end">
    ...
    Auth::user()->pessoa->animais()->count() < 4 and
    ...
    @if(Auth::user()->pessoa->perfilCompleto())
            ...
            <span class=" rounded-full text-sm text-white font-bold bg-yellow-300 px-2.5 -py-2 ">
  ...
  <div class="bg-white w-full flex items-center p-2 rounded-xl shadow border">
    <div class="p-2">
      <a wire:click.prevent="edit({{$animal}})" href="#" class="text-indigo-600 hover:text-indigo-900">
      ...
      <a wire:click.prevent="destroy({{$animal}})" href="#" class="text-red-600 hover:text-red-900 block">
        <svg class="mr-1 h-5 w-5 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
          stroke="currentColor">
