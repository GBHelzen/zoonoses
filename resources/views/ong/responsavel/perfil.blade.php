<div>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Perfil do resposável pela entidade ') }} <strong> {{ $this->ong->razao_social }} </strong>
        </h2>
    </x-slot>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Informações pessoais
                    </h3>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3 ">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        @error('user.name') <span class="text-red-700">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 ">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-masked-input id="cpf" :mask="'999.999.999-99'" class="block mt-1 w-full"
                                            type="text" name="cpf" :value="Auth::user()->cpf"/>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        @error('pessoa.rg') <span class="text-red-700">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-span-7 sm:col-span-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        @error('user.email') <span class="text-red-700">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
