<div
    class="invisible hidden md:visible lg:visible xl:visible md:block lg:block xl:block  shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
    ...
    <table class="invisible md:visible lg:visible xl:visible min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            @foreach ($animais as $animal)
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    @if($animal->servico_em_aberto == null || $animal->servico_concluido)
                    <a wire:click.prevent="destroy({{ $animal }})" href="#"
